// todo
// 普通啰嗦版https://cloud.tencent.com/developer/article/1483443
// 技巧版https://juejin.cn/post/6970300902703890468

/**
 * 思路 中学的竖式相加 个位对个位 十位对十位 满十进一
 * 注意要reverse方便for遍历
 * for遍历的结果再reverse回来就是答案
 * @param {*} num1 
 * @param {*} num2 
 * @returns 
 */
function bigNumAdd(num1, num2) {
  // 首先检查传来的大数必须是字符串类型，如果传Number类型的大数，在传入的时候已经丢失精度了，
